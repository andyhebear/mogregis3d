...
namespace scenic
{
	...
	/// <summary> This is the base class for shapes. Shapes are scene nodes that 
	...
	public abstract class SceneShape:SceneLeaf
	{
		...
		/// <summary> Gets the shape color.</summary>
		/// <summary> Sets the shape color.</summary>
		...
		internal override void  draw(DrawContext context, System.Drawing.Drawing2D.Matrix transform, ref System.Drawing.Rectangle visibleArea)
		{
			...
			if (false) // TODO PENDING surfaceType == Renderer.SURFACE_TYPE_COLOR || (surfaceType == context.surfaceType && color.White))
			{
