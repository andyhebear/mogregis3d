...
namespace scenic.path
{
	...
	/// <summary> This class defines a path that can be used for stroking and filling.
	...
	public class GenericPath : Path
	{
		...
		/// <summary> Creates a path that has the given subpaths.
		/// 
		/// </summary>
		...
		/// <summary> Walks the given walker through the path.
		/// 
		/// </summary>
		...
		/// <summary> Calculates the bounds of this path using the given transform.
		/// 
		/// </summary>
