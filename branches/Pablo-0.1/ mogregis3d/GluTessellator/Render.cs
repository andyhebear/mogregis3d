...
namespace Mogre.Utils.GluTesselator
{
	...
	class Render
	{
		private const bool USE_OPTIMIZED_CODE_PATH = false;
		
		private Render()
		{
		}
		
		//UPGRADE_NOTE: Final was removed from the declaration of 'renderFan '. 'ms-help://MS.VSCC.2003/commoner/redir/redirect.htm?keyword="jlca1003_3"'
		private static readonly RenderFan renderFan = new RenderFan();
		//UPGRADE_NOTE: Final was removed from the declaration of 'renderStrip '. 'ms-help://MS.VSCC.2003/commoner/redir/redirect.htm?keyword="jlca1003_3"'
		private static readonly RenderStrip renderStrip = new RenderStrip();
		//UPGRADE_NOTE: Final was removed from the declaration of 'renderTriangle '. 'ms-help://MS.VSCC.2003/commoner/redir/redirect.htm?keyword="jlca1003_3"'
		private static readonly RenderTriangle renderTriangle = new RenderTriangle();
		...
		*/
		...
		/// <summary>********************* Quick-and-dirty decomposition *****************</summary>
