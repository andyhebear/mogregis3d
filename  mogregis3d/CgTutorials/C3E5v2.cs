...
namespace Mogre.Demo.CgTutorials
{
    ...
    /// </summary>
    class C3E5Tutorialv2 : Mogre.Demo.ExampleApplication.Example
    {
        static ManualObject DrawTriangle(ManualObject obj)
        {
            ...
            obj.Begin("CgTutorials/C3E5_Materialv2", operation);
        ...
        {
            SceneNode node1 = base.sceneMgr.RootSceneNode.CreateChildSceneNode("Tutorial07Node1");

            ManualObject manualObj1 = sceneMgr.CreateManualObject("Tutorial07Object1");
