...
namespace Mogre.Utils.GluTesselator
{
	...
	abstract class PriorityQ
	{
		...
		{
			bool leq(System.Object key1, System.Object key2);
		}
		...
		internal abstract void  pqDeletePriorityQ();
		
		internal abstract bool pqInit();
		
		internal abstract int pqInsert(System.Object keyNew);
		
		internal abstract System.Object pqExtractMin();
		
		internal abstract void  pqDelete(int hCurr);
		
		internal abstract System.Object pqMinimum();
		
		internal abstract bool pqIsEmpty();
		//    #endif
	}
}